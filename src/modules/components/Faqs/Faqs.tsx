...
const faqsData = [
  ...
  },
  {
    ...
    content: (
      <>
        <Text>I think there are a few reasons why this does not exist yet:</Text>
        <br />
        <Text as="div">
          <ol>
            <li>1. Avalanche is extremely new and people haven't had time to build</li>
            <li>2. People are working on it now, but builders are busy fundraising</li>
            <li>
              3. It’s an extremely technical problem and not many people understand both Avalanche
              and liquid staking deeply enough to solve it
            </li>
          </ol>
        </Text>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <Text>
          I wanted to create and launch subnets on Avalanche which allows creators to incentivize
          their fans to grow the creator’s business using community DAOs.
        </Text>
        <br />
        <Text>
          But launching and growing a subnet is super expensive — each validator has to also
          validate the Avalanche chain, and I didn’t have a way to contact existing nodes to pick up
          my chain for validation. So I went to run my own validator node, and saw that each node
          must have a minimum stake of 2000 AVAX - making growing the subnet unfeasible, and locking
          me out of experimenting with the idea!
        </Text>
        <br />
        <Text>
          After doing research and seeing that no staking protocol was even close to existing, I
          decided to do something about it.
        </Text>
        <br />
        <Text>
          GoGoPool lets the next entrepreneur focus on their vision instead of having to worry about
          the node infrastructures of their blockchain.
        </Text>
      </>
    ),
  },
